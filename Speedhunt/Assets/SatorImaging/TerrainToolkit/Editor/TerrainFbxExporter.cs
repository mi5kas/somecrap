...
");
                ...
                float scale_x = scale_factor * (terrain.terrainData.size.x / (terrain.terrainData.heightmapWidth - 1));
                ...
                float scale_z = scale_factor * (terrain.terrainData.size.z / (terrain.terrainData.heightmapHeight - 1));
                //float scale_z = scale_factor * terrain.terrainData.size.z;
                //scale_z *= terrain.terrainData.size.z;

                float pos_y = 0;
                for (var z = 0; z < terrain.terrainData.heightmapHeight; z++)
                {
                    for (var x = 0; x < terrain.terrainData.heightmapWidth; x++)
                    {
                ...
                int num_polygons = (terrain.terrainData.heightmapWidth - 1) * (terrain.terrainData.heightmapHeight);
                int index_offset = terrain.terrainData.heightmapWidth;
                int skip_index = terrain.terrainData.heightmapWidth;

                for (var i = 0; i < num_polygons; i++)
                {
                    if (0 == (i + 1) % terrain.terrainData.heightmapWidth)
                    {
                        continue;
                    }
        ...
        LayerElementNormal: 0 {
            ...
            Normals: ");
                ...
                float local_pos_x = 1f / (terrain.terrainData.heightmapWidth - 1);
                float local_pos_z = 1f / (terrain.terrainData.heightmapWidth - 1);
        ...
        LayerElementUV: 0 {
            ...
            UV: ");
                ...
                local_pos_x = 1f / (terrain.terrainData.heightmapWidth - 1);
                local_pos_z = 1f / (terrain.terrainData.heightmapWidth - 1);
