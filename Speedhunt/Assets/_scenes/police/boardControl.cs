...
public class boardControl : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            Button tempButton = this.transform.GetChild(1).GetComponent<Button>();
            ...
            else if(PlayerPrefs.GetInt("blacklist1", 0) == 1)
            {
    ...
    public void ShowInfo(int whichInfo)
    {
        ...
        else if(whichInfo == 1) //Scotty's info
        {
            if(PlayerPrefs.GetInt("story", 0) < 7)
            {
            ...
            else if(PlayerPrefs.GetInt("blacklist1Status", 0) == 1)
            {
